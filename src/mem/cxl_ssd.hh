...
class CxlSSD : public SimpleMemory {
  private:
    ...
    Tick handleCNode(PacketPtr pkt, Addr pageAddr, Addr chunkAddr, int chunkIdx, bool isWrite);
    Tick handleSNode(PacketPtr pkt, Addr chunkAddr, int chunkIdx, bool isWrite);
